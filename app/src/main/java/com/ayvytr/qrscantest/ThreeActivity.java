    ...
    private void initView() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editText.setText("");
                mBitmap = QrUtils.createBitmap(textContent, 400, 400, BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editText.setText("");
                mBitmap = QrUtils.createBitmap(textContent, 400, 400, null);
                imageView.setImageBitmap(mBitmap);
            }
        });
    }
